...
import { WikiSearchPage } from './pages/wikisearch/wikisearch';
...
class ConferenceApp {
  ...
  appPages: PageObj[] = [
    ...
    { title: 'ScheduleNoTab', component: SchedulePage, icon : 'calendar' },
    { title: 'WikiSearch', component: WikiSearchPage, icon : 'calendar' },
  ];
...
ionicBootstrap(ConferenceApp, [ ConferenceData, UserData, WikipediaService, JSONP_PROVIDERS, ValidationService, ControlMessagesComponent, PushService, ElezioniService], { });
