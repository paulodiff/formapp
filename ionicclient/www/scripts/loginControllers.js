...
.controller("AppCtrl", 
                    ['$scope', '$rootScope', 'AuthService', 'Session', 'Restangular', '$state','$ionicLoading', '$ionicPopup','$ionicSideMenuDelegate', 'ENV', '$log','$location',
            function( $scope,   $rootScope,   AuthService,   Session,   Restangular,  $state, $ionicLoading,   $ionicPopup,  $ionicSideMenuDelegate,   ENV, $log, $location) {
...
.controller('LoginController', 
                    [ '$scope', '$ionicLoading', '$localStorage', '$rootScope', 'ENV', 'AuthService','$state', '$log',
            function ($scope, $ionicLoading, $localStorage,   $rootScope,   ENV,   AuthService,  $state,   $log) {
...
.controller('HelpController', 
    ...
    $scope.change_Api2 = function() {
        $scope.UrlApi = "https://pmlab.comune.rimini.it/SostaSelvaggia/";
        $rootScope.base_url = $scope.UrlApi;
        Restangular.setBaseUrl($rootScope.base_url); 
    }
