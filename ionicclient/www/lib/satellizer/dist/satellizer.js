            ...
            return this.$q(function (resolve, reject) {
                ...
                var polling = _this.$interval(function () {
                    ...
                    try {
                        ...
                        //Treat popup window origin and redirectUri 
                        popupWindowPath = popupWindowPath.trim(); 
                        if(popupWindowPath.endsWith('/')){ 
                            popupWindowPath = popupWindowPath.substr(0, popupWindowPath.length-1); } 
                        redirectUriPath = redirectUriPath.trim(); 
                        if(redirectUriPath.endsWith('/')){ 
                            redirectUriPath = redirectUriPath.substr(0, redirectUriPath.length-1); 
                        }
                        ...
                        if (popupWindowPath === redirectUriPath) {
                            ...
                            console.log('check ');
                            console.log(_this.popup.location.search);
                            console.log(_this.popup.location.hash);
